...
void seatest_assert_long_equal(long expected, long actual, const char* function, unsigned int line);
void seatest_assert_long_hex_equal(long expected, long actual, const char* function, unsigned int line);
...
#define assert_long_equal(expected, actual) do {  seatest_assert_long_equal(expected, actual, __FUNCTION__, __LINE__); } while (0)
#define assert_long_hex_equal(expected, actual) do {  seatest_assert_long_hex_equal(expected, actual, __FUNCTION__, __LINE__); } while (0)
